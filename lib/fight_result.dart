...
class FightResult {
  ...
  static const won = FightResult._("Won", FightClubColors.greenResult);
  static const lost = FightResult._("Lost", FightClubColors.redResult);
  static const draw = FightResult._("Draw", FightClubColors.blueResult);

  static const values = [won, lost, draw];

  static FightResult getName(final String name) {
